...
#Matthias
def location_to_string(location): #Matthias
...
#Matthias
def adjacent_location(location, direction):#Matthias
...
#not tested
#test first: is_legal_location; is_within_board; adjacent_location
